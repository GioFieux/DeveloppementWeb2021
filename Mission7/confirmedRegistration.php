...
<html lang="en" dir="ltr">
    ...
    if (isset($_POST['register'])) {
        ...
        if ($password!=$repeatpassword) { ?>
            <div class="alert alert-danger m-auto mt-5 p-5 w-25" role="alert" style='text-align: center' id='error'> <?php
                echo "Password are not corresponding"; ?>
                <a href="http://localhost/ZooTickoon/Mission7/inscription.php"> <br> Go back to register </a>
            </div> <?php 
        ...
        $stmt->execute(); ?>
        <div class="alert alert-success m-auto mt-5 p-5 w-25" role="alert" style='text-align: center' id='noError'> <?php
            echo "Account successfully created"; ?>
            <a href="http://localhost/ZooTickoon/Mission7/index.html" id="linkHome"> <br> Home </a> 
        </div> <?php 
        }
    }
    ?>
